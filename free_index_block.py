...
class FreeIndexBlock:
    def __init__(self, data_block_index: int, indexes: list[int], object_accessor: ObjectAccessor):
        ...
        assert len(self.indexes) == FREE_INDEX_PER_BLOCK
    ...
    def subblock(self, index: int) -> 'FreeIndexBlock':
        return FreeIndexBlock.from_index(self[index], self.object_accessor)